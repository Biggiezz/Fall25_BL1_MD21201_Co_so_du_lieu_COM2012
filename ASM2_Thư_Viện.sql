...
("PS18293","Nguyễn Hoàng Duy","2022-09-18","CNTT","duynhps18293@fpt.edu.vn","0919993715"),
...
("1A", "SQL", "FPT", "Bảo Ninh",156, 92, 150000, "2014-01-01", "a1", "KT"),
...
("D1","2017-05-04","2017-05-11","Chưa trả","PS18293"),
...
SELECT PM.NgayMuon, CTPM.GhiChu FROM CHITIETPHIEUMUON CTPM
...
SELECT LS.MaLoai, TenLoai, 
COUNT(MaSach) AS SoSach 
FROM SACH
...
SELECT PM.MaSV, TenSV, CTPM.MaPhieu, TenSach,NgayMuon,NgayTra 
FROM SINHVIEN SV
...
SELECT MaSach, COUNT(MaSach) AS SLSach FROM CHITIETPHIEUMUON
GROUP BY MaSach
...
SELECT CTPM.MaPhieu, SV.TenSV, SV.Email, SACH.TenSach, PM.NgayMuon 
